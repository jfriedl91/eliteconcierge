...
import { LogOut, LayoutDashboard, ArrowLeft, ArrowRight, Menu, X } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const MemberLayout = () => {
  const { memberLogout } = useMemberAuth();
      ...
      <header className="fixed top-0 left-0 right-0 bg-secondary/80 backdrop-blur-lg border-b border-gold/20 z-40">
        <div className="container mx-auto flex justify-between items-center py-3 px-4 sm:px-6 h-[70px]">
          <div className="flex items-center gap-6">
            <NavLink to="/mitglieder/dashboard" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline text-sm font-bold text-gold uppercase tracking-wider">Mitgliederbereich</span>
            </NavLink>
