...
const packages = {
  smart: [{
    ...
    details: '3 Anfragen/Monat, Erreichbarkeit Mo-Fr 10-16 Uhr. Bearbeitung von Anfragen i.d.R. innerhalb von 72 Stunden. Leistungen: Arzt- & Behördentermine, KFZ-Zulassung, Reiseplanung (Flug+Hotel), Alltagsorganisation. Kontakt via E-Mail.'
  }, {
    name: 'Smart Plus',
    price: '195,00 € inkl. MwSt.',
    details: '7 Anfragen/Monat, Erreichbarkeit Mo-Fr 9-17 Uhr. Bearbeitung von Anfragen i.d.R. innerhalb von 72 Stunden. Leistungen wie Smart 100 + Geschenkideen, Restaurant- & Eventbuchungen (Standard). Kontakt via E-Mail.'
  }, {
    name: 'Smart Flex',
    price: '295,00 € inkl. MwSt.',
    details: '12 Anfragen/Monat, Erreichbarkeit Mo-Fr 9-18 Uhr. Bearbeitung von Anfragen i.d.R. innerhalb von 72 Stunden. Leistungen wie Smart Plus + Premium-Reiseplanung, Unterstützung bei Wohnungssuche, WG-Zimmer-Suche & Umzug, leichte Sonderwünsche. Kontakt via E-Mail.'
  }],
  premium: [{
    name: 'PRIME',
    price: '690,00 € inkl. MwSt.',
    details: <>20 Anfragen/Monat (privat & geschäftlich), Erreichbarkeit Mo-Fr 8-18 Uhr. Bearbeitung von Anfragen i.d.R. innerhalb von 48 Stunden. Komplexe Organisationen, Premium-Ticketing, Business Concierge, monatlicher Strategie-Call. Kontakt via Telefon, E-Mail & Messenger.</>
  }, {
    name: 'ELITE',
    price: '2.400,00 € inkl. MwSt.',
    details: <>Unlimitierte Anfragen (gem. <DialogClose asChild><Link to="/fair-use-policy" className="text-gold hover:underline">Fair Use Policy</Link></DialogClose>), 24/7 Erreichbarkeit. Bearbeitung von Anfragen i.d.R. innerhalb von 24 Stunden. Persönlicher Ansprechpartner, Zugang zu Events/Restaurants, spezialisierter Reise- & Immobilien-Concierge, wöchentliche Strategie-Calls. Kontakt via Telefon, E-Mail & Messenger.</>
  }, {
    name: 'BESPOKE',
    price: '130,00 € / Stunde zzgl. USt.',
    details: 'Vollindividualisierte Betreuung nach Aufwand. Bearbeitung von Anfragen i.d.R. innerhalb von 12 Stunden. Alle Leistungen von ELITE plus: eigenes Backoffice-Team, persönliche Assistenz vor Ort, internationale Abdeckung, NDA & Ghost-Service. Kontakt via Telefon, E-Mail & Messenger.'
  }]
};
...
export const AgbDialog = ({ children }) => {
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-4xl h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-grow overflow-hidden">
          <ScrollArea className="h-full px-6 py-4">
            <div className="text-sm text-platinum/80 prose prose-invert prose-p:mb-4 prose-h2:text-gold prose-h2:text-xl prose-h2:font-bold prose-h2:mb-4 prose-h3:text-gold prose-h3:text-lg prose-h3:font-semibold prose-h3:mt-4 prose-h3:mb-2 prose-strong:text-gold prose-a:text-gold prose-a:hover:underline">
               <section>
            ...
            <section>
              <h2>§ 2 Leistungsgegenstand und Vertragsschluss</h2>
              <p>
              ...
              <p>
                (4) Das ELITE-Paket beinhaltet eine unbegrenzte Anzahl von Anfragen, die einer <DialogClose asChild><Link to="/fair-use-policy" className="text-gold hover:underline">Fair Use Policy</Link></DialogClose> unterliegt. Diese stellt sicher, dass die Servicequalität für alle Kunden auf höchstem Niveau gehalten wird.
              </p>
              <p>
            ...
            <section>
              <h2>§ 4 Preise, Zahlungsbedingungen und Aufrechnung</h2>
              <p>
            ...
            <section>
              <h2>§ 4a Sonderaktionen und Rabatte</h2>
            ...
            <section>
              ...
              <p>(5) Im Falle einer dauerhaften, übermäßigen Nutzung des ELITE-Pakets gemäß der <DialogClose asChild><Link to="/fair-use-policy" className="text-gold hover:underline">Fair Use Policy</Link></DialogClose>, steht beiden Parteien ein Sonderkündigungsrecht mit einer Frist von einem (1) Tag zu. Im Falle einer Kündigung durch den Kunden wird der bereits entrichtete Monatsbeitrag anteilig und tagesgenau für den nicht genutzten Zeitraum zurückerstattet. Erfolgt die Kündigung aus diesem Grund durch den Anbieter, entfällt der Anspruch auf Rückerstattung.</p>
            ...
            <section>
              ...
              <p>(3) Die Einzelheiten zum Widerrufsrecht, insbesondere zu Fristen, Vorgehen und Folgen, sind der gesonderten <DialogClose asChild><Link to="/widerruf" className="text-gold hover:underline">Widerrufsbelehrung</Link></DialogClose> zu entnehmen.</p>
            </section>
            ...
            <section>
              <h2>§ 11 Online-Streitbeilegung</h2>
            ...
            <section>
              <h2 className="mt-8 mb-6">Anhang 1: Preis- und Leistungsverzeichnis</h2>
              <PriceTable />
            </section>
            </div>
          </ScrollArea>
